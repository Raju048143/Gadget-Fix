...
<body>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="loginDropdown">
          <a class="dropdown-item" href="#" data-toggle="modal" data-target="#user-login">User Login</a>
          <a class="dropdown-item" href="#" data-toggle="modal" data-target="#user-register-Modal">User Register</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="#" data-toggle="modal" data-target="#admin-Modal">Admin Login</a>
          <a class="dropdown-item" href="#" data-toggle="modal" data-target="#repair-expert-Modal">Repair Expert Login</a>
        </div>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="#" data-toggle="modal" data-target="#my-Modal">Contact</a>
      </li>
  ...
  <section class="container my-5">
      <div class="row text-center align-items-center">
          ...
          <div class="col-sm p-4" data-aos="zoom-in" data-aos-duration="1000">
              <h3><span class="text-danger">Welcome</span> to GadgetFix</h3>
              <p> GadgetFix enables to Repair Gadgets. Whether your smartphone, tablet, laptop, or any other electronic device is experiencing issues, our platform offers a user-friendly experience to help you get your gadgets up and running again</p>
          </div>
      </div>
  </section>
  ...
  <section class="bg-dark text-white p-5 text-center" id="service">
      ...
      <div class="row mt-5 mb-3">
          <div class="col-sm">
              <div>
                  <p><i class="fa-solid fa-angle-right"></i>Screen </p>
                  <p><i class="fa-solid fa-angle-right"></i> Battery</p>
                  <p><i class="fa-solid fa-angle-right"></i>MIC&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </p>
                 
              </div>
          </div>
          <div class="col-sm">
              <div>
                  <p><i class="fa-solid fa-angle-right"></i> Charging Jack</p>
                  <p><i class="fa-solid fa-angle-right"></i>Speaker &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
                  <p><i class="fa-solid fa-angle-right"></i> AUX Jack&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
          ...
          <div class="col-sm">
            <div>
                  <p><i class="fa-solid fa-angle-right"></i>FronT Camera </p>
                  <p><i class="fa-solid fa-angle-right"></i> Back Camera</p>
                  <p><i class="fa-solid fa-angle-right"></i> Back Panel&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
  ...
  <section class="container my-5">
      <div class="row text-center align-items-center">
          <div class="col-sm p-4" data-aos="zoom-in" data-aos-duration="1000">
              ...
              <p>GadgetFix web application aims to provide a convenient, transparent, and efficient solution for users to get their electronic devices repaired by skilled technicians, ensuring optimal functionality and customer satisfaction.
              </p>
          </div>
...
I recently had the opportunity to use the GadgetFix web application, and I must say that it exceeded my expectations. As someone who frequently encounters technical issues with my devices, finding a reliable and efficient solution has always been a priority for me. GadgetFix proved to be the perfect tool to address my tech-related problems            </p>
      ...
      <div class="col-sm">
        <div>
           ...
           <p>
             <span><i class="fa-solid fa-quote-left fa-3x"></i></span>
I recently had the opportunity to use the GadgetFix web application for repairing my smartphone, and I must say, it exceeded all my expectations. As someone who heavily relies on their gadgets, finding a reliable and efficient repair service is crucial. GadgetFix not only delivered on these fronts but also provided a seamless user experience.           </p>
      ...
      <div class="col-sm">
        <div>
          <img src="resources/person1.jpg" alt="">
          <p>
            <span><i class="fa-solid fa-quote-left fa-3x"></i></span>I recently had the opportunity to use the GadgetFix web application to repair a malfunctioning smartphone, and I must say that I was impressed with its comprehensive features and user-friendly interface. GadgetFix offers a one-stop solution for gadget repairs, making it a valuable tool for both tech-savvy individuals and professionals in the industry.</p>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="post" action="UserSignIn">
                <input name="email" class="form-control p-4 my-2" type="email" maxlength="45"  placeholder="Email" 
                 pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Please enter a valid email address (e.g., user@example.com)" required />
                <input name="password" class="form-control p-4 my-2" type="password" maxlength="20" placeholder=" Password" 
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="post" action="AdminLogin">
                <input name="id" class="form-control p-4 my-2" type="text" maxlength="20"  placeholder="Admin ID" 
                  pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Please enter a valid email address (e.g., user@example.com)" required />
                <input name="password" class="form-control p-4 my-2" type="password" maxlength="20" placeholder="Admin Password"
                 pattern="(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}"
                  title="Password must be at least 8 characters long and include uppercase, lowercase, a number, and a special character." required />
                <div class="d-flex justify-content-end">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="post" action="RepairExpertLogin">
                <input name="email" class="form-control p-4 my-2" type="email" maxlength="100"  placeholder="Email ID"
                 pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Please enter a valid email address (e.g., user@example.com)" required />
                <input name="password" class="form-control p-4 my-2" type="password" maxlength="20" placeholder="Password"
                pattern="(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}"
                  title="Password must be at least 8 characters long and include uppercase, lowercase, a number, and a special character." required />
  ...
  <!-- User Registration -->
  <div class="modal fade" id="user-register-Modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header bg-info text-white">
        ...
        <div class="modal-body">
            <form method="post" action="UserSignUp">
               <input name="email" class="form-control p-2 my-2" type="email" maxlength="100" placeholder="Email"
                pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Please enter a valid email address (e.g., user@example.com)" required />
                		...
                		<input name="password" class="form-control p-2 my-2" type="password" maxlength="20" placeholder="Password" pattern="(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}"
                            title="Password must be at least 8 characters long and include uppercase, lowercase, a number, and a special character." required />
                		<div class="d-flex justify-content-end">
